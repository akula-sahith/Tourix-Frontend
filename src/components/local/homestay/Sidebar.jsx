...
export default function Sidebar() {
  ...
  const menuItems = [
    { name: "Home", path: "/homestay", icon: <Home size={20} /> },
    { name: "Earnings", path: "/homestay/earnings", icon: <DollarSign size={20} /> },
    { name: "Services Provided", path: "/homestay/services", icon: <Briefcase size={20} /> },
    { name: "Services Applied", path: "/homestay/applied", icon: <ClipboardList size={20} /> },
    { name: "Services Approved", path: "/homestay/approved", icon: <BadgeCheck size={20} /> },
    { name: "Bookings", path: "/homestay/bookings", icon: <ShoppingBag size={20} /> },
  ];
