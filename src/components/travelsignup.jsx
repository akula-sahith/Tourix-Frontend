  ...
  return (
    <>
      <style>{`
        ...
        @keyframes form-morph-in {
          from { opacity: 0; transform: scale(0.9) translateY(20px); }
          to { opacity: 1; transform: scale(1) translateY(0); }
        }
        
        @keyframes form-morph-out {
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      {errors.firstName && (
                        <p className="text-red-600 text-sm mt-1" role="alert">{errors.firstName}</p>
                      )}
                    </div>
                    <div>
                      ...
                      {errors.lastName && (
                        <p className="text-red-600 text-sm mt-1" role="alert">{errors.lastName}</p>
                      )}
                    </div>
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      {errors.confirmPassword && (
                        <p className="text-red-600 text-sm mt-1" role="alert">{errors.confirmPassword}</p>
                      )}
                    </div>
                  </div>
                  <div>
                    ...
                    {errors.agreeTerms && (
                      <p className="text-red-600 text-sm mt-2" role="alert">{errors.agreeTerms}</p>
                    )}
                  </div>
                  <button
                    type="button"
