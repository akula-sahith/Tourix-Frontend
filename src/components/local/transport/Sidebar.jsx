...
export default function Sidebar() {
  ...
  const menuItems = [
    { name: "Home", path: "/transport", icon: <Home size={20} /> },
    { name: "Earnings", path: "/transport/earnings", icon: <DollarSign size={20} /> },
    { name: "Services Provided", path: "/transport/services", icon: <Briefcase size={20} /> },
    { name: "Services Applied", path: "/transport/applied", icon: <ClipboardList size={20} /> },
    { name: "Services Approved", path: "/transport/approved", icon: <BadgeCheck size={20} /> },
    { name: "Bookings", path: "/transport/bookings", icon: <ShoppingBag size={20} /> },
  ];
