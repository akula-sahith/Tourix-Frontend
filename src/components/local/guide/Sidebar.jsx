...
export default function Sidebar() {
  ...
  const menuItems = [
    { name: "Home", path: "/guide", icon: <Home size={20} /> },
    { name: "Earnings", path: "/guide/earnings", icon: <DollarSign size={20} /> },
    { name: "Services Provided", path: "/guide/services", icon: <Briefcase size={20} /> },
    { name: "Services Applied", path: "/guide/applied", icon: <ClipboardList size={20} /> },
    { name: "Services Approved", path: "/guide/approved", icon: <BadgeCheck size={20} /> },
    { name: "Bookings", path: "/guide/bookings", icon: <ShoppingBag size={20} /> },
  ];
